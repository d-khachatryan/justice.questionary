...
{
    public partial class frmQuestionT3 : Form
    {
        string strLanguage;
        ...
        public frmQuestionT3(string language, string connectionString, int questionT3ID)
        {
            ...
            this.vCourtBS.DataSource = from p in db.vCourts where p.Court_ID == 1 select p;
            ...
            this.questionT3BS.DataSource = from p in db.QuestionT3s where p.QuestionT3_ID == questionT3ID select p;

            if (questionT3ID == 0)
            {
                this.questionT3BS.AddNew();
                this.questionT3BS.EndEdit();
            }
            this.ActiveControl = this.mskQuestionNumber;
        }

        private void FrmQuestionT3FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (!isCommandClose)
        ...
        private bool CheckCells()
        {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Court_ID == null)
            {
            ...
            ////// TabPage1
            if (((QuestionT3)this.questionT3BS.Current).Gender_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Date_Interval_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT3_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT4_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT5_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT6_ID == null)
            {
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question14))
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT7_ID == null)
            {
            ...
            ////// TabPage2
            if (((QuestionT3)this.questionT3BS.Current).CatalogT8_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).CatalogT9_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Public_Lawyer_Service_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Public_Lawyer_Service_Payment_ID == null)
            {
            ...
            ////// TabPage3
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question13))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
                ActiveControl = this.mskQuestion13;
                return false;
            }
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question15))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
                ActiveControl = this.mskQuestion15;
                return false;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question16))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question17))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question18))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question19))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question20))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question21))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
                ActiveControl = this.mskQuestion21;
                return false;
            }

            ////// TabPage4
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question22))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
                ActiveControl = this.mskQuestion22;
                return false;
            }

            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question23))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question24))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question25))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question26))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question27))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question28))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            ////// TabPage5
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question29))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
                ActiveControl = this.mskQuestion29;
                return false;
            }
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question29_2))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
                ActiveControl = this.mskQuestion29_2;
                return false;
            }

            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question30))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
                ActiveControl = this.mskQuestion30;
                return false;
            }
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question30_2))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question31))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question32))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question33))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question34))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question35))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question36))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            ////// TabPage6
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question37))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question38))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question39))
            {
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question40))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question41))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question42))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question43))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question44))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question45))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question46))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            ////// TabPage7
            if (!this.CheckNumericField(((QuestionT3)this.questionT3BS.Current).Question47))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            //if (((QuestionT3)this.questionT3BS.Current).Communication_Type_ID == null)
            //{
            //    MessageBox.Show("48-րդ հարցը լրացված չէ", "Ուշադրություն", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            //    this.MainTabControl.SelectedTab = this.tabPage7;
            //    ActiveControl = this.cboCommunicationType;
            //    return false;
            //}

            if (((QuestionT3)this.questionT3BS.Current).Scan_Provision_Type_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Scan_Provision_Cost_ID == null)
            {
            ...
            if (((QuestionT3)this.questionT3BS.Current).Resource_Estimation_Type_ID == null)
            {
        ...
        private int CommitChanges()
        {
            ...
            if ((changes.Inserts.Count + changes.Updates.Count + changes.Deletes.Count) > 0)
            {
                ((QuestionT3)this.questionT3BS.Current).User_Name = GlobalClass.UserName;
                this.questionT3BS.EndEdit();
            }
            db.SubmitChanges();
            isTableChanged = true;
        ...
        {
            this.mskQuestion29.Text = "444";
            this.mskQuestion29_2.Text = "444";
        ...
        {
            this.mskQuestion29.Text = "555";
            this.mskQuestion29_2.Text = "555";
        ...
        {
            this.mskQuestion29.Text = "777";
            this.mskQuestion29_2.Text = "777";
        ...
        {
            this.mskQuestion29.Text = "888";
            this.mskQuestion29_2.Text = "888";
        ...
        {
            this.mskQuestion29.Text = "999";
            this.mskQuestion29_2.Text = "999";
