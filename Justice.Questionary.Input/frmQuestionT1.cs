...
{
    public partial class frmQuestionT1 : Form
    {
        string strLanguage;
        ...
        public frmQuestionT1(string language, string connectionString, int questionTID)
        {
            ...
            this.vCatalogT30BS.DataSource = from p in db.vCatalogT30s select p;
            ...
            this.questionT1BS.DataSource = from p in db.QuestionT1s where p.QuestionT1_ID == questionTID select p;

            if (questionTID == 0)
            {
                this.questionT1BS.AddNew();
        ...
        private bool CheckCells()
        {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Court_ID == null)
            {
            ...
            ////// TabPage1
            if (((QuestionT1)this.questionT1BS.Current).Gender_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Date_Interval_ID  == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT3_ID  == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT4_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT5_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT6_ID == null)
            {
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question14))
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT7_ID == null)
            {
            ...
            ////// TabPage2
            if (((QuestionT1)this.questionT1BS.Current).CatalogT8_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT9_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).CatalogT10_ID == null)
            {
            ...
            //if (this.cboCatalogT10Detail.SelectedIndex == -1)
            //{
            //    MessageBox.Show("10-րդ հարցը լրացված չէ", "Ուշադրություն", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            //    this.MainTabControl.SelectedTab = this.tabPage2;
            //    ActiveControl = this.cboCatalogT10Detail;
            //    return false;
            //}

            if (((QuestionT1)this.questionT1BS.Current).Public_Lawyer_Service_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Public_Lawyer_Service_Payment_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Lawyer_Service_ID == null)
            {
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question15))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
                ActiveControl = this.mskQuestion15;
                return false;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question16))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question17))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question18))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question19))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question20))
            {
                this.MainTabControl.SelectedTab = this.tabPage3;
            ...
            ////// TabPage4
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question23))
            {
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question24))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question25))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question26))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question27))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question28))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question29))
            {
                this.MainTabControl.SelectedTab = this.tabPage4;
            ...
            ////// TabPage5
            if (((QuestionT1)this.questionT1BS.Current).CatalogT30_ID == null)
            {
                MessageBox.Show("30-րդ հարցը լրացված չէ", "Ուշադրություն", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.MainTabControl.SelectedTab = this.tabPage5;
                ActiveControl = this.cboCatalogT30;
                return false;
            }

            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question31))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question32))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question33))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question34))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question35))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question36))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question37))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question38))
            {
                this.MainTabControl.SelectedTab = this.tabPage5;
            ...
            ////// TabPage6
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question39))
            {
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question40))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question41))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question42))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question43))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question44))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question45))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question46))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question47))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question48))
            {
                this.MainTabControl.SelectedTab = this.tabPage6;
            ...
            ////// TabPage7
            if (!this.CheckNumericField(((QuestionT1)this.questionT1BS.Current).Question49))
            {
                this.MainTabControl.SelectedTab = this.tabPage7;
                ActiveControl = this.mskQuestion49;
                return false;
            }

            //if (((QuestionT1)this.questionT1BS.Current).Communication_Type_ID == null)
            //{
            ...
            if (((QuestionT1)this.questionT1BS.Current).Scan_Provision_Type_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Scan_Provision_Cost_ID == null)
            {
            ...
            if (((QuestionT1)this.questionT1BS.Current).Resource_Estimation_Type_ID == null)
            {
                MessageBox.Show("53-րդ հարցը լրացված չէ", "Ուշադրություն", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.MainTabControl.SelectedTab = this.tabPage7;
